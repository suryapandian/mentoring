...
**Live**: https://software.suryapandian.workers.dev
...
- Landing page: https://software.suryapandian.workers.dev/ (updated with new session card)
- Voting app: https://software.suryapandian.workers.dev/april-xyz
...
- **Single unified worker** at `software.suryapandian.workers.dev` handles all sessions and the landing page
